...
import { REWARD_TOKEN_ADDRESSES, STAKE_CONTRACT_ADDRESSES, STAKE_TOKEN_ADDRESSES } from "../constants/adresses";
...
export default function Stake() {
    ...
    } = useContract(STAKE_TOKEN_ADDRESSES, "token");//(address,type)
    const {
    ...
    const {
        data: stakeInfo,//storing getStakeInfo
        refetch: refetchStakeInfo,
        isLoading: loadingStakeInfo
    } = useContractRead(
        stakeContract,
        "getStakeInfo",//how much token we have stake and how much reward we have avaliable to claim
        [address]
    );
    //token balace
    const {
